...
class BatchesControllerTest < ActionController::TestCase
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post :create, batch: { course_id: @batch.course_id, end_year: @batch.end_year, is_active: @batch.is_active, start_year: @batch.start_year }
    end
  ...
  test "should update batch" do
    patch :update, id: @batch, batch: { course_id: @batch.course_id, end_year: @batch.end_year, is_active: @batch.is_active, start_year: @batch.start_year }
    assert_redirected_to batch_path(assigns(:batch))
  end
